...
|------------|-----------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Raphaël P. | 25 %                  | `EmergencyManagerService`, `FireService`, stratégie de dispatch multi-critères, scoring normalisé, liquide/carburant, multi-casernes, repositionnement centroïde, chaînage feu→feu, corrections majeures, stratégies          |
